      ...
      <main>
        ...
        <div className="us">
          <div className="content">
            <div className="text">
              ...
              <p>
                Outre l&rsquo;expédition de nos produits, nous accompagnons nos
                clients et techniciens dans leurs projets en leurs apportant
                tout le soutien nécessaire ce qui inclus les plans, les
                simulations et les aides à la mise-en-service.
              </p>
            </div>
            <div className="text">
              <h4>
            ...
            <div className="text">
              ...
              <p>
                Notre équipe dispose de compétences spécialisées auxquelles vous
                pouvez vous fier. Vous bénéficierez de conseils personnalisés et
                adaptés.
              </p>
            </div>
            <div className="text">
              ...
              <p>
                ...
                considérablement dans l&rsquo;accompagnement de nos partenaires.
              </p>
            </div>
          </div>
        ...
        <div className="ref">
          ...
          <Ref image="ref_1" title="Mosque of Saint-Etienne (France)" />
            ...
            />
            <Ref image="ref_6" title="ECRAN X-Board Salle de réunion Shenzen" />
            <Ref
              image="ref_7"
          ...
          <div className="secondZoomDescription">
            ...
            <div className="fistParagraphe">
              ...
              <p className="">
                ...
                User-level front maintenance all-weather protection technology,
                anti-broken <br />
                LED,moisture-proof,anti-static, radiation-proof, wear-resisting
                and <br />
        ...
        <div className="contact">
          <div className="left">
            <p className="contactSubtitle">Vous avez un projet à réaliser ?</p>
